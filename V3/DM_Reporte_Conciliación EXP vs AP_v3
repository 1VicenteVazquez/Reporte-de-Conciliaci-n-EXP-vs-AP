...
,BASE_DATOS AS (
    SELECT
        ...
        ,TO_CHAR(EER.FINAL_APPROVAL_DATE, 'DD/MM/YYYY')     FECHA_DE_CREACION             -- #6
        ,ROW_NUMBER() OVER (
        ...
        ,EE.TAX_CLASSIFICATION_CODE                         CODIGO_DE_IMPUESTO_EXP        -- #26
        ,CAST(NULL AS NUMBER)                               IMPORTE_IMPUESTO_EXP          -- #27
        ,IAP.TAX_CODE_ID                                    CODIGO_DE_IMPUESTO_AP         -- #28
        ,NVL(IAP.TOTAL_TAX_AMOUNT_REAL, 0)                  IMPORTE_IMPUESTO_AP           -- #29
        ,(NVL(0, 0) - NVL(IAP.TOTAL_TAX_AMOUNT_REAL, 0))     DIFERENCIA_IMPUESTO           -- #30
        ,CCPG.CODE_COMBINATION_ID                           COMBINACION_CONTABLE_EXP_ID   -- #31
    ...
    WHERE
        ...
        AND (XEP.NAME = NVL(:P_RAZON_SOCIAL, XEP.NAME) OR :P_RAZON_SOCIAL IS NULL)
        ...
        AND (CCPG.CODE_COMBINATION_ID = NVL(:P_CUENTA_CONTABLE, CCPG.CODE_COMBINATION_ID) OR :P_CUENTA_CONTABLE IS NULL)
