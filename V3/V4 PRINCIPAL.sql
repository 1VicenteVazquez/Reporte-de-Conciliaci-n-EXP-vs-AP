...
SELECT 
    ...
    ,UNIDAD_NEGOCIO
    ,NOMBRE_DEL_EMPLEADO
    ,NUM_INFORME_DE_GASTOS
    ,ESTADO_DEL_INFORME
    ,FECHA_DE_CREACION
    ,LINEA_DE_GASTO
    ,FECHA_DEL_GASTO_LINEA
    ,TIPO_DE_GASTO
    ,DESCRIPCION_DEL_GASTO
    ,NOMBRE_COMERCIANTE_PROVEEDOR_EXP
    ,NUMERO_DE_FACTURA_AP
    ,PROVEEDOR_AP
    ,ESTADO_FACTURA_AP
    ,FECHA_FACTURA_AP
    ,FECHA_CONTABLE_AP
    ,MONEDA_INTRODUCIDA_EXP
    ,IMPORTE_EXP_MONEDA_INTRODUCIDA
    ,IMPORTE_AP_MONEDA_INTRODUCIDA
    ,DIFERENCIA_MONEDA_INTRODUCIDA
    ,TIPO_DE_CAMBIO
    ,MONEDA_FUNCIONAL
    ,IMPORTE_EXP_MONEDA_FUNCIONAL
    ,IMPORTE_AP_MONEDA_FUNCIONAL
    ,DIFERENCIA_MONEDA_FUNCIONAL
    ,CODIGO_DE_IMPUESTO_EXP
    ,IMPORTE_IMPUESTO_EXP
    ,CODIGO_DE_IMPUESTO_AP
    ,IMPORTE_IMPUESTO_AP
    ,DIFERENCIA_IMPUESTO
    ,COMBINACION_CONTABLE_EXP_ID
    ,COMBINACION_CONTABLE_AP
    ,DIFERENCIA_CUENTA_CONTABLE
FROM BASE_DATOS
